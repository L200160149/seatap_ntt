          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                  <li class="nav-item">
                      <a href="<?= base_url() ?>/dashboard" class="nav-link <?= ($uriSegments[1] == 'dashboard' ? 'active' : '') ?>">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url() ?>/donasi" class="nav-link <?= ($uriSegments[1] == 'donasi' ? 'active' : '') ?>">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url() ?>/users" class="nav-link <?= ($uriSegments[1] == 'pengguna' ? 'active' : '') ?>">
